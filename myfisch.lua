...
local Window = OrionLib:MakeWindow({Name = "Jesmang HUB | Fisch", HidePremium = false, IntroEnabled = false, SaveConfig = false, ConfigFolder = "Jesmang"})
...
--Teleport
function TPDepths()
	rootPart.CFrame = CFrame.new(962.612793, -710.921082, 1291.8678, -1, 0, 0, 0, 1, 0, 0, 0, -1) + Vector3.new(0, 5, 0)
end

function TPAltar()
	rootPart.CFrame = CFrame.new(1298.83813, -807.237671, -307.547272, 0.0331695676, 0, 0.99944973, 0, 1, 0, -0.99944973, 0, 0.0331695676) + Vector3.new(0, 5, 0)
end

function TPMoosewood()
	rootPart.CFrame = CFrame.new(383.060181, 131.240601, 267.647491, -0.457844615, 0, -0.889032245, 0, 1, 0, 0.889032245, 0, -0.457844615) + Vector3.new(0, 5, 0)
end

function TPDeep()
	rootPart.CFrame = CFrame.new(-1660.67505, -217.181732, -2844.40723, 0.454964399, 0.000282441149, 0.890509605, -1.20638724e-05, 0.99999994, -0.000311004551, -0.890509605, 0.000130753004, 0.45496434) + Vector3.new(0, 5, 0)
end

function TPForsaken()
	rootPart.CFrame = CFrame.new(-2530.19751, 132.015152, 1558.64465, 0, 0, -1, 0, 1, 0, 1, 0, 0) + Vector3.new(0, 5, 0)
end
